  ...
  return (
    <div className="fixed top-0 lg:top-[65px] left-0 right-0 bottom-0 flex flex-col lg:left-72">
      ...
      <div className="relative bg-gradient-to-br from-white/15 via-white/10 to-white/5 backdrop-blur-2xl border border-white/30 rounded-2xl sm:rounded-3xl p-3 sm:p-4 mx-3 sm:mx-4 mt-2 mb-2 flex items-center space-x-3 sm:space-x-4 shadow-[0_8px_32px_-4px_rgba(0,0,0,0.5),0_4px_16px_rgba(0,0,0,0.3),inset_0_2px_1px_rgba(255,255,255,0.12),inset_0_-2px_1px_rgba(0,0,0,0.1)] animate-fadeIn overflow-hidden">
        ...
        <div className={`absolute left-0 top-0 bottom-0 w-1 bg-gradient-to-b ${categoryGradient}`}></div>
        ...
        {/* Category color subtle tint */}
        <div className={`absolute inset-0 rounded-2xl sm:rounded-3xl bg-gradient-to-br ${categoryGradient} opacity-5 pointer-events-none`}></div>
      ...
      <div className="flex-1 overflow-y-auto overflow-x-hidden px-3 sm:px-4 min-h-0" style={{ WebkitOverflowScrolling: 'touch', touchAction: 'pan-y' }}>
          ...
          <div className="text-center text-white/80 px-2 py-4 animate-fadeIn">
            ...
            <div className="space-y-2.5">
              {persona.conversation_starters?.map((starter, idx) => (
                ...
                >
                  {/* Category color accent - left bar */}
                  <div className={`absolute left-0 top-0 bottom-0 w-1 bg-gradient-to-b ${categoryGradient} opacity-0 group-hover:opacity-100 transition-opacity duration-500`}></div>

                  {/* Category color tint on hover */}
                  <div className={`absolute inset-0 rounded-2xl sm:rounded-3xl bg-gradient-to-br ${categoryGradient} opacity-0 group-hover:opacity-5 transition-opacity duration-500 pointer-events-none`}></div>
        ...
        {isLoading && (
          <div className="flex justify-start mb-4 animate-fadeIn">
            <div className="relative bg-gradient-to-br from-white/15 via-white/10 to-white/5 backdrop-blur-2xl border border-white/30 px-4 sm:px-5 py-3 sm:py-3.5 rounded-3xl shadow-[0_6px_24px_-2px_rgba(0,0,0,0.4),inset_0_2px_1px_rgba(255,255,255,0.12)] overflow-hidden">
              {/* Category color subtle tint */}
              <div className={`absolute inset-0 rounded-3xl bg-gradient-to-br ${categoryGradient} opacity-10 pointer-events-none`}></div>
              ...
              <div className="relative z-10 flex space-x-2">
                <div className={`w-2 h-2 bg-gradient-to-br ${categoryGradient} rounded-full animate-bounce shadow-[0_0_12px_rgba(102,126,234,0.6)]`} />
                <div className={`w-2 h-2 bg-gradient-to-br ${categoryGradient} rounded-full animate-bounce delay-100 shadow-[0_0_12px_rgba(102,126,234,0.6)]`} />
                <div className={`w-2 h-2 bg-gradient-to-br ${categoryGradient} rounded-full animate-bounce delay-200 shadow-[0_0_12px_rgba(102,126,234,0.6)]`} />
              </div>
            </div>
          </div>
        )}

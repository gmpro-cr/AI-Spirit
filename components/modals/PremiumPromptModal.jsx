...
export default function PremiumPromptModal({ isOpen, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-60 backdrop-blur-sm">
      <div className="bg-white border-2 border-black rounded-lg shadow-2xl p-8 max-w-md w-full mx-4">
        ...
        <div className="bg-gray-50 border-2 border-gray-200 rounded-lg p-5 mb-6">
          <h3 className="font-bold text-black mb-3 text-center">Premium Benefits</h3>
        ...
        <div className="flex flex-col gap-3">
          ...
          <button
            ...
            className="w-full bg-gray-100 text-black border-2 border-gray-300 py-3 px-4 rounded-lg font-semibold hover:bg-gray-200 transition-colors"
          >

 ...
 */
export async function extractAndSaveMemories(userId, personaSlug, conversationId, userMessage, aiResponse) {
 ...
 */
export async function getUserMemories(userId, personaSlug = null) {
    if (!userId) return []
    ...
    try {
        ...
        // If personaSlug provided, get memories for that persona
        // Otherwise get all memories (shared across personas)
        if (personaSlug) {

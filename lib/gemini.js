...
// Fallback chain of free models — ordered by reliability then quality
// Popular models (llama, gemma, mistral) are often rate-limited on the free tier,
// so we lead with less congested but still capable models
const FREE_MODELS = [
  'nvidia/nemotron-3-nano-30b-a3b:free',                // 30B, reliable, good quality
  'z-ai/glm-4.5-air:free',                              // Good quality, different provider
  'meta-llama/llama-3.3-70b-instruct:free',              // Best quality but often rate-limited
  'google/gemma-3-27b-it:free',                          // Good fallback
  'mistralai/mistral-small-3.1-24b-instruct:free',       // Another fallback
]

...
export default function HomeDesignV8() {
    ...
    return (
        <>
            <Head>
                ...
                <meta name="description" content="A clean black‑and‑white landing page for AI‑Spirit, showcasing featured personas with subtle interactions." />
            </Head>

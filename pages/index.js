    ...
    <>
      ...
      <div className="min-h-screen bg-white">
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
              ...
              <div className="lg:col-span-1">
                <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-black mb-16 leading-tight whitespace-nowrap">
                  Enter the world of AI Personas
                </h2>
                <p className="text-lg md:text-xl text-gray-600 mb-20 max-w-xl leading-relaxed text-justify">
              ...
              <div className="lg:col-span-1 flex justify-center lg:justify-end">
                <div className="bg-white rounded-2xl shadow-2xl p-8 border border-gray-100 transition-all duration-500 w-full max-w-md h-[500px] flex flex-col">
                  <div className="flex items-center gap-4 mb-8 pb-6 border-b border-gray-100 flex-shrink-0">
                    <img
                    ...
                    />
                    <div>
                      <p className="font-semibold text-black text-lg">{chatPersonas[currentPersonaIndex].name}</p>
                      <p className="text-sm text-gray-500">{chatPersonas[currentPersonaIndex].category}</p>
                    </div>
                  </div>
                      ...
                      <div key={`completed-${index}`}>
                        {message.type === 'user' ? (
                          ...
                          <div className="flex justify-end">
                            <div className="bg-black text-white px-4 py-2.5 rounded-2xl rounded-br-sm max-w-[85%]">
                          ...
                          <div className="flex gap-2">
                            ...
                            />
                            <div className="bg-gray-100 text-black px-4 py-2.5 rounded-2xl rounded-bl-sm max-w-[85%]">
                              <p className="text-sm">{message.text}</p>
                            </div>
                          </div>
                        )}
        ...
        <section className="py-24 px-6 bg-gray-50">
          <div className="max-w-7xl mx-auto">
            <h3 className="text-4xl md:text-5xl font-bold text-black text-center mb-16">
              Featured Personas
            </h3>
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
              {featuredPersonas.map((persona, index) => (
                ...
                >
                  <div className="w-28 h-28 md:w-32 md:h-32 rounded-full overflow-hidden mb-4 shadow-lg group-hover:shadow-2xl transition-shadow">
                    <img
                      src={persona.image}
                      alt={persona.name}
                  ...
                  <p className="font-semibold text-black text-lg">{persona.name}</p>
                </button>
              ))}
            </div>
          </div>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-12">
              ...
              <div className="text-center">
                ...
                <h4 className="text-2xl font-bold text-black mb-3">Authentic Conversations</h4>
              ...
              <div className="text-center">
                ...
                <h4 className="text-2xl font-bold text-black mb-3">Always Available</h4>
                <p className="text-gray-600 leading-relaxed">
              ...
              <div className="text-center">
                ...
                <h4 className="text-2xl font-bold text-black mb-3">Privacy First</h4>
                <p className="text-gray-600 leading-relaxed">
        ...
        <section className="py-24 px-6 bg-gray-50">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-12 max-w-5xl mx-auto">
              {/* Step 1 */}
              <div className="text-center">
                <div className="w-20 h-20 rounded-full border-2 border-gray-300 flex items-center justify-center mx-auto mb-6">
                  <span className="text-4xl font-bold text-black">1</span>
                </div>
                <h4 className="text-xl font-bold text-black mb-3">Choose a Persona</h4>
                <p className="text-gray-600 leading-relaxed">

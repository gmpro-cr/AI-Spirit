...
export default function Home() {
  return (
    <>
      ...
      <main className="relative min-h-screen bg-gradient-dark pt-32 pb-16 px-4 z-10">
        <div className="max-w-7xl mx-auto w-full">
          ...
          <div className="text-center animate-fadeIn">
            ...
            <p className="text-xl text-text-secondary mb-48 max-w-2xl mx-auto leading-relaxed">

...
export default function SignIn() {
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-white text-black flex flex-col transition-colors">
        {/* Header */}
        <header className="px-6 md:px-12 py-6 flex justify-between items-center animate-fadeIn relative z-20">
          <Link href="/">
            <h1 className="text-xl md:text-2xl font-black tracking-tight cursor-pointer text-black">
        ...
        <main className="flex-1 flex items-center justify-center px-6 py-8 relative">
          ...
          <div className="w-full max-w-md relative z-10">
            <div className="bg-white border-2 border-black rounded-lg shadow-xl p-8 transition-colors">

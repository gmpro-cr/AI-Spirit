...
export default function PrivacyPolicy() {
  return (
    <>
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-spirit-bg-dark py-12 transition-colors px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto bg-white dark:bg-spirit-bg-secondary-dark shadow-sm rounded-lg p-8 transition-colors">
          {/* Header */}
          <div className="mb-8">
            <Link href="/" className="text-blue-600 dark:text-spirit-accent hover:text-blue-800 dark:hover:text-spirit-accent/80 text-sm">
              ← Back to Home
            </Link>
            <h1 className="text-4xl font-bold text-gray-900 dark:text-spirit-primary-dark mt-4">Privacy Policy</h1>
          ...
          <div className="prose prose-lg max-w-none">
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-spirit-primary-dark mb-4">1. Introduction</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-spirit-primary-dark mb-4">2. Information We Collect</h2>
              <p className="text-gray-700 dark:text-gray-300 mb-2">We collect and process the following information:</p>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-spirit-primary-dark mb-4">3. How We Use Your Information</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-spirit-primary-dark mb-4">4. Data Storage and Security</h2>
              <p className="text-gray-700 dark:text-gray-300">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-spirit-primary-dark mb-4">5. Third-Party Services</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-spirit-primary-dark mb-4">6. Your Rights</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-spirit-primary-dark mb-4">7. Data Retention</h2>
              <p className="text-gray-700 dark:text-gray-300">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-spirit-primary-dark mb-4">8. Children&apos;s Privacy</h2>
              <p className="text-gray-700 dark:text-gray-300">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-spirit-primary-dark mb-4">9. Changes to This Policy</h2>
              <p className="text-gray-700 dark:text-gray-300">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-spirit-primary-dark mb-4">10. Contact Us</h2>
              <p className="text-gray-700 dark:text-gray-300">
                If you have any questions about this privacy policy or our data practices, please contact us at:
              </p>
              <p className="text-gray-700 dark:text-gray-300 mt-2">
                <Link href="/contact" className="text-blue-600 dark:text-spirit-accent hover:text-blue-800 dark:hover:text-spirit-accent/80">
                  Contact Form
                </Link>
              </p>
            </section>
          ...
          <div className="mt-12 pt-8 border-t border-gray-200">
            <div className="flex justify-between text-sm text-gray-600 dark:text-gray-400">
              <Link href="/terms" className="hover:text-gray-900 dark:text-spirit-primary-dark">
                Terms of Service
              </Link>
              <Link href="/" className="hover:text-gray-900 dark:text-spirit-primary-dark">
                Back to Home
              </Link>
            </div>
          </div>
